...
const pakcage = {
  name: "@shevernitskiy/post-tracking",
  description: "RussianPost tracking API client",
  version: Deno.args[0],
  ...
  repository: {
    type: "git",
    url: "https://github.com/shevernitskiy/post-tracking",
  },
  files: ["./src", "./mod.js", "./mod.d.ts"],
  main: "./mod.js",
  types: "./mod.d.ts",
  keywords: ["russian post", "tracking", "api", "client", "typescript", "javascript", "deno", "nodejs", "node"],
};
